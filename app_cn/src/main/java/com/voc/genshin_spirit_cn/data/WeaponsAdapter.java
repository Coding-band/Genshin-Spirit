 ...
 * Package com.voc.genshin_spirit_cn.data.WeaponsAdapter was
                    ...
                    if (context instanceof MainActivity) {
                        ...
                        if (str != null) {
                            try {
                                ...
                                ((TextView) inflate.findViewById(R.id.item_name)).setText(context.getString(itemRss.getWeaponByName(name)[0]));
