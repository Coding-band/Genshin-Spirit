...
public final class BuffDBContract {
    // To prevent someone from accidentally instantiating the contract class,
    // make the constructor private.
    private BuffDBContract() {}

    /* Inner class that defines the table contents */

    public static final String DATASHEET_HEAD_DATASHEET = "Set_";
    public static final String DATASHEET_HEAD_ACCOUNTDATA = "Account_";
    public static class DataBase implements BaseColumns {
        public static final String TABLE_NAME = "Catelogy";
        ...
        public static final String COLUMN_NAME_UPDATE_UNIX = "update_unix";
