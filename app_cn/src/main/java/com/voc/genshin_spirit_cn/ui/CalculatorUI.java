...
import com.voc.genshin_spirit_cn.buff.BuffCal2;
...
import com.voc.genshin_spirit_cn.util.CalculatorProcess;
...
import com.voc.genshin_spirit_cn.buff.CalculatorBuff;
...
public class CalculatorUI extends AppCompatActivity implements NumberPicker.OnValueChangeListener {
    ...
    public void weaponQuestion (String CharName_BASE, String XPR, int k, int rare){
        ...
        menu_char_lvl_before.setText(getString(R.string.curr_lvl)+String.valueOf(before_lvl));
        menu_char_lvl_after.setText(getString(R.string.aim_lvl)+String.valueOf(after_lvl));
        menu_title.setText(context.getString(item_rss.getWeaponByName(CharName_BASE)[0]));
 ...
 */
        ...
        menu_char_lvl_before.setText(getString(R.string.curr_lvl)+String.valueOf(before_lvl));
        menu_char_lvl_after.setText(getString(R.string.aim_lvl)+String.valueOf(after_lvl));
        menu_title.setText(context.getString(item_rss.getArtifactByName(item_rss.getArtifactNameByFileName(CharName_BASE))[0]));
