...
public class ItemRss {
    ...
    public int[] getCharByName(String name){
        if(name.equals("Gorou")){return new int[] {R.drawable.gorou_flag,R.string.gorou,R.drawable.gorou_full,R.drawable.gorou_ico};}
