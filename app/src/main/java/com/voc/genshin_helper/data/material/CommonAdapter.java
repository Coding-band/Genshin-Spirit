...
public class CommonAdapter extends RecyclerView.Adapter<CommonAdapter.CommonViewHolder> {
    ...
    public CommonAdapter(Context context, List<Materials> materialsList, Activity activity){
    ...
    public CommonViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new CommonViewHolder(LayoutInflater.from(context).inflate(R.layout.item_cal_img,parent,false));
    }
