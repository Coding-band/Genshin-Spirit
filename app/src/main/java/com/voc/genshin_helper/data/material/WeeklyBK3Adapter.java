...
public class WeeklyBK3Adapter extends RecyclerView.Adapter<WeeklyBK3Adapter.WeeklyBK3ViewHolder> {

    private List<Materials> materialsList;
    Context context;
    Activity activity;

    public WeeklyBK3Adapter(Context context, List<Materials> materialsList, Activity activity){
    ...
    @NonNull
    @Override
    public WeeklyBK3ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new WeeklyBK3ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_cal_img,parent,false));
    }

    @Override
    public void onBindViewHolder(WeeklyBK3ViewHolder holder, int position) {
    ...
    public class WeeklyBK3ViewHolder extends RecyclerView.ViewHolder {


        public TextView item_count,item_weekly_tv;
        public ImageView item_icon,item_press_mask;

        public WeeklyBK3ViewHolder(@NonNull View itemView) {
            super(itemView);
