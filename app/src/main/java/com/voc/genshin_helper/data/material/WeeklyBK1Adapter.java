...
public class WeeklyBK1Adapter extends RecyclerView.Adapter<WeeklyBK1Adapter.WeeklyBK1ViewHolder> {

    private List<Materials> materialsList;
    Context context;
    Activity activity;

    public WeeklyBK1Adapter(Context context, List<Materials> materialsList, Activity activity){
    ...
    @NonNull
    @Override
    public WeeklyBK1ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new WeeklyBK1ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_cal_img,parent,false));
    }

    @Override
    public void onBindViewHolder(WeeklyBK1ViewHolder holder, int position) {
    ...
    public class WeeklyBK1ViewHolder extends RecyclerView.ViewHolder {


        public TextView item_count,item_weekly_tv;
        public ImageView item_icon,item_press_mask;

        public WeeklyBK1ViewHolder(@NonNull View itemView) {
            super(itemView);
