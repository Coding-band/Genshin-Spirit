...
public class WeeklyBK2Adapter extends RecyclerView.Adapter<WeeklyBK2Adapter.WeeklyBK2ViewHolder> {

    private List<Materials> materialsList;
    Context context;
    Activity activity;

    public WeeklyBK2Adapter(Context context, List<Materials> materialsList, Activity activity){
    ...
    @NonNull
    @Override
    public WeeklyBK2ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new WeeklyBK2ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_cal_img,parent,false));
    }

    @Override
    public void onBindViewHolder(WeeklyBK2ViewHolder holder, int position) {
        ...
        int column = width_curr/200;
        int size_per_img = width_curr/column;

        if(width_curr/column > 200){
            size_per_img = 200;
        }
        ...
        holder.item_count.setText(item_rss.getLocaleTeaches(materials.getName(),context));
    }
    ...
    public class WeeklyBK2ViewHolder extends RecyclerView.ViewHolder {


        public TextView item_count,item_weekly_tv;
        public ImageView item_icon,item_press_mask;

        public WeeklyBK2ViewHolder(@NonNull View itemView) {
            super(itemView);
