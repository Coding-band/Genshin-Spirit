...
public class OtherAdapter extends RecyclerView.Adapter<OtherAdapter.OtherViewHolder> {
    ...
    public OtherAdapter(Context context, List<Materials> materialsList, Activity activity){
    ...
    public OtherViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new OtherViewHolder(LayoutInflater.from(context).inflate(R.layout.item_cal_img,parent,false));
    }
