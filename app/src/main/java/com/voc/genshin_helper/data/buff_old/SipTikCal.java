...
public class SipTikCal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Character Icon
        Picasso.get()
                .load (item_rss.getCharByName(characters.getName(),context)[3]).transform(transformation_circ)
    ...
    public void weaponChoosed(Weapons weapons){
        ...
        siptik_weapon_name.setText(item_rss.getWeaponByName(weapons.getName())[0]);
        Picasso.get()
                .load (item_rss.getWeaponByName(weapons.getName())[1]).transform(transformation_circ)
                .error (R.drawable.paimon_full)
    ...
    public void artifactChoose(Artifacts artifacts, int pos){
        ...
        switch (pos){
            case 1 : {
                ...
                siptik_set1_name.setText(item_rss.getArtifactByName(artifacts.getName())[0]);
                Picasso.get()
                        .load (item_rss.getArtifactByName(artifacts.getName())[1]).transform(transformation_circ)
                        .error (R.drawable.paimon_full)
            ...
            case 2 : {
                ...
                siptik_set2_name.setText(item_rss.getArtifactByName(artifacts.getName())[0]);
                Picasso.get()
                        .load (item_rss.getArtifactByName(artifacts.getName())[1]).transform(transformation_circ)
                        .error (R.drawable.paimon_full)
