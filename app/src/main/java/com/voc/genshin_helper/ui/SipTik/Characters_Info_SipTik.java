...
public class Characters_Info_SipTik {
    ...
    public void show() {
        ...
        View view = View.inflate(context, R.layout.fragment_char_info_frame_siptik, null);
        ...
        ScrollView scrollView = view.findViewById(R.id.info_scroll);
        ...
        /** Method of menu */
        CardView director_value_card = view.findViewById(R.id.director_value_card);
        CardView director_advice_card = view.findViewById(R.id.director_advice_card);
        CardView director_cons_card = view.findViewById(R.id.director_cons_card);
        CardView director_talent_card = view.findViewById(R.id.director_talent_card);
        CardView director_char_card = view.findViewById(R.id.director_char_card);
        ...
        /** Method of introduce */
        TextView info_intro_tv = view.findViewById(R.id.info_intro_tv);

        /** Method of value btn */
        ImageView info_talent1_value_btn = view.findViewById(R.id.info_talent1_value_btn);
        ImageView info_talent2_value_btn = view.findViewById(R.id.info_talent2_value_btn);
        ImageView info_talent3_value_btn = view.findViewById(R.id.info_talent3_value_btn);
        ImageView info_char_base_value_btn = view.findViewById(R.id.info_char_base_value_btn);
        ...
        /** Method of advice */
        LinearLayout advice_main_weapon_sc = view.findViewById(R.id.advice_main_weapon_sc);
        ...
        LinearLayout advice_support_weapon_sc = view.findViewById(R.id.advice_support_weapon_sc);
        ...
        LinearLayout advice_util_weapon_sc = view.findViewById(R.id.advice_util_weapon_sc);
        ...
        LinearLayout info_main_ll = view.findViewById(R.id.info_main_ll);
        TextView info_main_sand_tv = view.findViewById(R.id.info_main_sand_tv);
        TextView info_main_goblet_tv = view.findViewById(R.id.info_main_goblet_tv);
        TextView info_main_circlet_tv = view.findViewById(R.id.info_main_circlet_tv);
        TextView info_main_sub_tv = view.findViewById(R.id.info_main_sub_tv);

        LinearLayout info_support_ll = view.findViewById(R.id.info_support_ll);
        TextView info_support_sand_tv = view.findViewById(R.id.info_support_sand_tv);
        TextView info_support_goblet_tv = view.findViewById(R.id.info_support_goblet_tv);
        TextView info_support_circlet_tv = view.findViewById(R.id.info_support_circlet_tv);
        TextView info_support_sub_tv = view.findViewById(R.id.info_support_sub_tv);

        LinearLayout info_util_ll = view.findViewById(R.id.info_util_ll);
        TextView info_util_sand_tv = view.findViewById(R.id.info_util_sand_tv);
        TextView info_util_goblet_tv = view.findViewById(R.id.info_util_goblet_tv);
        TextView info_util_circlet_tv = view.findViewById(R.id.info_util_circlet_tv);
        TextView info_util_sub_tv = view.findViewById(R.id.info_util_sub_tv);
        ...
        TextView info_advice_main = view.findViewById(R.id.info_advice_main);
        TextView info_advice_support = view.findViewById(R.id.info_advice_support);
        TextView info_advice_util = view.findViewById(R.id.info_advice_util);
        TextView info_advice_team = view.findViewById(R.id.info_advice_team_tv);
        TextView info_advice_result = view.findViewById(R.id.info_advice_result);

        LinearLayout base_lvl_ll = view.findViewById(R.id.base_lvl_ll);
        LinearLayout talent_lvl_ll = view.findViewById(R.id.talent_lvl_ll);

        readCharMaterialByBuff(base_lvl_ll,view);
        readSkillMaterialByBuff(talent_lvl_ll,view);
                    ...
                    director_menu_card.animate()
                            ...
                            .setListener(new AnimatorListenerAdapter() {
                                ...
                                public void onAnimationStart(Animator animation) {
                                    ...
                                    director_advice_card.setTop(advice_pos);
                                    director_cons_card.setTop(cons_pos);
                                    director_talent_card.setTop(talent_pos);
                                    director_value_card.setTop(value_pos);

                                    director_value_card.animate().alpha(0f).setDuration(300).y(director_menu_card.getTop());
                                    director_advice_card.animate().alpha(0f).setDuration(300).y(director_menu_card.getTop());
                                    director_cons_card.animate().alpha(0f).setDuration(300).y(director_menu_card.getTop());
        ...
        director_char_card.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                scrollView.smoothScrollTo(0,info_char_bg.getTop()-8);
            }
        });
        director_talent_card.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                scrollView.smoothScrollTo(0,info_talent.getTop()-8);
            }
        });
        director_cons_card.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                scrollView.smoothScrollTo(0,info_sof.getTop()-8);
            }
        });
        director_advice_card.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                scrollView.smoothScrollTo(0,info_advice.getTop()-8);
            }
        });
        director_value_card.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                scrollView.smoothScrollTo(0,info_data.getTop());
            }
        });
