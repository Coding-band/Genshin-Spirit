...
public class BuffDB {
    ...
    public String undate_unix; //資料表更新時間

    public BuffDB() {

    }

    public BuffDB(String name, long id, int char_cnt, int weapon_cnt, int artifact_cnt, String create_unix, String undate_unix) {
        this.name = name;
        this.id = id;
    ...
    public String getUndate_unix() {
        return undate_unix;
    }

    public void setUndate_unix(String undate_unix) {
        this.undate_unix = undate_unix;
    }
}
