...
public class BossAdapter extends RecyclerView.Adapter<BossAdapter.BossViewHolder> {
    ...
    public BossAdapter(Context context, List<Materials> materialsList, Activity activity){
    ...
    public BossViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new BossViewHolder(LayoutInflater.from(context).inflate(R.layout.item_cal_img,parent,false));
    }

    @Override
    public void onBindViewHolder(BossViewHolder holder, int position) {
