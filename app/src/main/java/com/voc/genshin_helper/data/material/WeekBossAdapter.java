...
public class WeekBossAdapter extends RecyclerView.Adapter<WeekBossAdapter.WeekBossViewHolder> {

    private List<Materials> materialsList;
    Context context;
    Activity activity;

    public WeekBossAdapter(Context context, List<Materials> materialsList, Activity activity){
    ...
    @NonNull
    @Override
    public WeekBossViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new WeekBossViewHolder(LayoutInflater.from(context).inflate(R.layout.item_cal_img,parent,false));
    }

    @Override
    public void onBindViewHolder(WeekBossViewHolder holder, int position) {
    ...
    public class WeekBossViewHolder extends RecyclerView.ViewHolder {


        public TextView item_count,item_weekly_tv;
        public ImageView item_icon,item_press_mask;

        public WeekBossViewHolder(@NonNull View itemView) {
            super(itemView);
